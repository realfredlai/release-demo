...
const DialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-wrap md:items-center justify-center gap-2',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-center font-semibold leading-none tracking-tight',
      className
    )}
    {...props}
  />
